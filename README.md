...
21.安装 *`tmux`* -------------------------------------------------------------------------(一个非常好用的终端工具)，

22.安装 *`iperf`* -------------------------------------------------------------------(网络工具，可以测试内网网速),

23.安装 *`figlet`* -----------------------------------------------(命令生成字符画，只支持英文,数字和部分符号),

24.安装 *`lsof`* ---------------------------------------------------------------------(可以显示端口被哪些进程占用),

25.安装 *`dpkg`* -------------------------------------------------------------------------------------(安装deb安装包),

26.安装 *`hdparm`* -------------------------------------------------------------------------------(测试硬盘读写速率),

27.安装 *`smartmontools`* ---------------------------------------------------------------------(测试硬盘健康状态),

28.安装 *`psmisc`* -----------------------------------------------------------------------------(killall命令),

29.安装 *`fping`* --------------------------------------------------------------------------(检测某个IP是否活跃)。
