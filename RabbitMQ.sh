...
if [ $centos6 = 1 ]; then
    ...
    wget https://github.com/rabbitmq/erlang-rpm/releases/download/v21.3.8.1/erlang-21.3.8.1-1.el6.x86_64.rpm
...
if [ $centos7 = 1 ]; then
    echo -e "\033[1;31m 4.下载erlang \033[0m"
    wget https://github.com/rabbitmq/erlang-rpm/releases/download/v21.3.8.1/erlang-21.3.8.1-1.el7.x86_64.rpm
    echo -e "\033[1;31m 5.安装erlang \033[0m"
